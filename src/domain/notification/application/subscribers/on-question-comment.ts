...
export class OnQuestionComment implements EventHandler {
    ...
    private async sendQuestionCommentNotification({ questionId }: QuestionCommentEvent) {

        const question = await this.questionsRepository.findById(questionId.toString())
